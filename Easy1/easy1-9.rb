...
output:
-one positive integer (the sum of the individual digits of the input)
...
Your Mental Model: The method will take the integer input and separate the number into its individual
digits and then find the sum of those digits.  It will then return the result as an integer.
...
-Separate the integer into it's digits
