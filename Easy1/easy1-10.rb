...
output:
-bonus value, either 0 or a positive integer
...
Your Mental Model: The method will check the boolean value and if it is false, it will return 0, if it 
is true, it will multiply the given integer input by 0.5 and return the bonus amount.
...
-Check if boolean value is false, if false return 0.
-If boolean value is true, multiply by 0.5 and return the bonus as an integer.
